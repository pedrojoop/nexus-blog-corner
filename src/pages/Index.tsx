...
import { ArrowRight, CheckCircle, Users, TrendingUp, Zap, Heart, AlertTriangle, BarChart3, Target, Linkedin, Play, ChevronDown } from "lucide-react";
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight animate-fade-in">
            Transforme Sua Cultura<br />Organizacional
          </h1>
          <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
            A plataforma que unifica engajamento, colaboração e gestão de talentos para prevenir turnover e construir equipes de alto desempenho
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <Button 
              ...
              className="bg-nexus-accent text-white hover:bg-nexus-accent/90 shadow-2xl px-8 py-6 text-lg"
            >
            ...
            <Link to="/auth">
              <Button 
                size="lg" 
                variant="outline" 
                className="bg-white/10 text-white border-2 border-white hover:bg-white hover:text-nexus-green shadow-2xl px-8 py-6 text-lg backdrop-blur-sm"
              >
